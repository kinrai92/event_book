...
Route::get("cooperation_login", "CooperationController@login_menu")->name("cooperation_login_menu");
Route::post("cooperation_login", "CooperationController@login_coop")->name("cooperation_login");
Route::get("cooperation_logout", "CooperationController@logout_coop")->name("cooperation_logout");
Route::get('welcome_cop','CooperationController@index')->name('cooperation_loggedin');
